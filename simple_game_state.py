...
class CardGameState(object):
    ...
    def reset(self):
        ...
        self.my_cards = np.array([[[1.0], [1.0], [1.0]]])
        self.target_cards = np.array([[[1.0], [1.0], [1.0]]])
    ...
    def process(self, action):
        self.my_cards[0][action][0] = 0.0
        
        if self.target_cards[0][action][0] == 1.0:
            self.target_cards[0][action][0] = 0.0
